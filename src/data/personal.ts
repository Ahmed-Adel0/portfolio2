...
export const whyMeContent: WhyMeContent = {
  ...
  paragraphs: [
    "أنا مهندس برمجيات ومحلل نظم، باحث بكلية الدراسات العليا للبحوث الإحصائية قسم علوم البيانات - جامعة القاهرة. أتعامل مع البرمجيات كأداة لحل مشكلات الأعمال وليس مجرد كتابة كود. أركز على فهم طبيعة نشاطك وتحويله إلى نظام رقمي يرفع الكفاءة ويزيد العائد.",
